...
class AirhockeyDefend(experiment.AbstractIterativeExperiment):
    def initialize(self, cw_config: dict,
        ...
        dataset = util.load_pkl_dataset(cfg["dataset"]["task"],
                                        cfg["dataset"]["dataset_name"],
                                        cfg["dataset"]["max_path_length"],
                                        cfg["dataset"]["horizon"],
                                        cfg["mp"]["mp_args"]["dt"])
...
if __name__ == "__main__":
    cw = cluster_work.ClusterWork(AirhockeyDefend)
